...
class JudgeAgent:
    ...
    def check_requirement(self, criteria: str, workflow: list, user_query: str, model="gpt-4o"):
        ...
        combined_evidence = ""
        related_files = []
        model_name = getattr(self.llm, 'model_name', 'gpt-4o')
        workspace_info = truncate_string(
            self.display_tree(), model=self.llm.model_name, max_tokens=18284
        )
