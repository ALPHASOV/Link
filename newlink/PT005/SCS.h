...
#define MKSP(Offset,Segment) \
 ((uword huge *)((((ulong)(Segment)) <<16U) + (Offset)))
#define NOP _nop_
#define SHUGE huge
#ifndef SCU_PSCSTAT
#  define SCU_PSCSTAT (*((uword volatile sdata *)0xFFE8))
...
//*****************************************************************************
// @Function      INLINE void Scs_EnableHighPrecOsc(uword Enable)
//
//-----------------------------------------------------------------------------
...
INLINE void Scs_EnableHighPrecOsc(uword Enable)
{
  if(Enable)
  {
